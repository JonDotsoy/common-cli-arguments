export namespace modPodmanComposeRm {
  const conf = {"usages":["docker compose rm [OPTIONS] [SERVICE...]"],"usageMatrix":[{"argsStr":["[OPTIONS]","[SERVICE...]"],"args":[{"keyword":"options","literal":"[OPTIONS]","kind":"options","isOptionsArg":true,"isOptional":true,"isSpread":false},{"keyword":"service","literal":"[SERVICE...]","kind":"argument","isOptionsArg":false,"isOptional":true,"isSpread":true}],"tsOptions":{"options":{"kind":"Options","optional":true},"service":{"kind":"string[]","optional":true}},"tsOptionsSort":["options","service"],"tsOptionsStr":"{options?: Options;service?: string[];}"}],"command":"podman compose rm","options":{"dryRun":{"keyName":"dryRun","flag":"--dry-run"},"force":{"keyName":"force","flag":"--force"},"stop":{"keyName":"stop","flag":"--stop"},"volumes":{"keyName":"volumes","flag":"--volumes"}}};
