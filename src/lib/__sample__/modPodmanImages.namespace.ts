export namespace modPodmanImages {
  const conf = {"usages":["podman images [options] [IMAGE]"],"usageMatrix":[{"argsStr":["[options]","[IMAGE]"],"args":[{"keyword":"options","literal":"[options]","kind":"options","isOptionsArg":true,"isOptional":true,"isSpread":false},{"keyword":"image","literal":"[IMAGE]","kind":"argument","isOptionsArg":false,"isOptional":true,"isSpread":false}],"tsOptions":{"options":{"kind":"Options","optional":true},"image":{"kind":"string","optional":true}},"tsOptionsSort":["options","image"],"tsOptionsStr":"{options?: Options;image?: string;}"}],"command":"podman images","options":{"all":{"keyName":"all","flag":"--all"},"digests":{"keyName":"digests","flag":"--digests"},"filter":{"keyName":"filter","flag":"--filter","typeValue":"stringArray"},"format":{"keyName":"format","flag":"--format","typeValue":"string"},"history":{"keyName":"history","flag":"--history"},"noTrunc":{"keyName":"noTrunc","flag":"--no-trunc"},"noheading":{"keyName":"noheading","flag":"--noheading"},"quiet":{"keyName":"quiet","flag":"--quiet"},"sort":{"keyName":"sort","flag":"--sort","typeValue":"string"}}};
