export namespace modPodmanNetworkLs {
  const conf = {"usages":["podman network ls [options]"],"usageMatrix":[{"argsStr":["[options]"],"args":[{"keyword":"options","literal":"[options]","kind":"options","isOptionsArg":true,"isOptional":true,"isSpread":false}],"tsOptions":{"options":{"kind":"Options","optional":true}},"tsOptionsSort":["options"],"tsOptionsStr":"{options?: Options;}"}],"command":"podman network ls","options":{"filter":{"keyName":"filter","flag":"--filter","typeValue":"stringArray"},"format":{"keyName":"format","flag":"--format","typeValue":"string"},"noTrunc":{"keyName":"noTrunc","flag":"--no-trunc"},"noheading":{"keyName":"noheading","flag":"--noheading"},"quiet":{"keyName":"quiet","flag":"--quiet"}}};
