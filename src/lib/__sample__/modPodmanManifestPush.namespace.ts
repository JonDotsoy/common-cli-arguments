export namespace modPodmanManifestPush {
  const conf = {"usages":["podman manifest push [options] LIST DESTINATION"],"usageMatrix":[{"argsStr":["[options]","LIST","DESTINATION"],"args":[{"keyword":"options","literal":"[options]","kind":"options","isOptionsArg":true,"isOptional":true,"isSpread":false},{"keyword":"list","literal":"LIST","kind":"argument","isOptionsArg":false,"isOptional":false,"isSpread":false},{"keyword":"destination","literal":"DESTINATION","kind":"argument","isOptionsArg":false,"isOptional":false,"isSpread":false}],"tsOptions":{"options":{"kind":"Options","optional":true},"list":{"kind":"string","optional":false},"destination":{"kind":"string","optional":false}},"tsOptionsSort":["options","list","destination"],"tsOptionsStr":"{options?: Options;list: string;destination: string;}"}],"command":"podman manifest push","options":{"addCompression":{"keyName":"addCompression","flag":"--add-compression","typeValue":"strings"},"all":{"keyName":"all","flag":"--all"},"authfile":{"keyName":"authfile","flag":"--authfile","typeValue":"string"},"compressionFormat":{"keyName":"compressionFormat","flag":"--compression-format","typeValue":"string"},"compressionLevel":{"keyName":"compressionLevel","flag":"--compression-level","typeValue":"int"},"creds":{"keyName":"creds","flag":"--creds","typeValue":"[username[:password]]"},"digestfile":{"keyName":"digestfile","flag":"--digestfile","typeValue":"string"},"forceCompression":{"keyName":"forceCompression","flag":"--force-compression"},"format":{"keyName":"format","flag":"--format","typeValue":"string"},"quiet":{"keyName":"quiet","flag":"--quiet"},"removeSignatures":{"keyName":"removeSignatures","flag":"--remove-signatures"},"rm":{"keyName":"rm","flag":"--rm"},"tlsVerify":{"keyName":"tlsVerify","flag":"--tls-verify"}}};
