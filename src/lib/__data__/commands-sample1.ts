            ...
            usageMatrix: [
              {
                ...
                tsOptionsSort: ["options", "arg"],
                tsOptionsStr: "{options?: Options;arg: string;}",
              },
            ],
